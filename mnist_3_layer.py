...
w1 = tf.Variable(tf.random_normal([784,100], stddev=0.01), name="W1_layer1")
b1 = tf.Variable(tf.zeros([batch_size,100], name="B1_layer1"))

w2 = tf.Variable(tf.random_normal([100,60], stddev=0.01), name="W2_layer2")
b2 = tf.Variable(tf.zeros([batch_size,60]), name="B2_layer2")

w3 = tf.Variable(tf.random_normal([60,10], stddev=0.01), name="W3_layer3")
b3 = tf.Variable(tf.zeros([batch_size,10]), name="B3_layer3")
'''
